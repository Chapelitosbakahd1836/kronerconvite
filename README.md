...
Dois cliques em `index.html` mostram o hero de imagem estática, que é a versão
...
O `index.html` fica na raiz de propósito: assim Vercel, GitHub Pages, Netlify e
hospedagem comum servem o site sem nenhuma configuração.
...
É uma pasta de arquivos estáticos servida direto da raiz. Qualquer hospedagem serve:
Vercel e Netlify publicam sozinhos ao conectar o repositório, e no GitHub Pages basta
apontar para a branch `main` e a pasta raiz. Antes de publicar, troque as duas URLs marcadas com
